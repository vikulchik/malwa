	...
	<?php do_action( 'woocommerce_before_cart_totals' ); ?>
        ...
        <div class="box">
            <div class="hgroup title">
                <h3><?php _e( 'Всього в кошику', 'woocommerce' ); ?></h3>
                <h5><?php echo __('', DOMAIN);?></h5>
            </div>
	...
	<table cellspacing="0">
		...
		<?php foreach ( WC()->cart->get_coupons( 'cart' ) as $code => $coupon ) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr( $code ); ?>">
				<th><?php _e( 'Знижка:', 'woocommerce' ); ?> <?php echo esc_html( $code ); ?></th>
		...
		<tr class="order-total">
			<th><?php _e( 'Підсумок замовлення', 'woocommerce' ); ?></th>
